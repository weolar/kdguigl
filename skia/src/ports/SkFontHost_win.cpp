...
static void logfont_for_name(const wchar_t* familyName, LOGFONT* lf) {
	sk_bzero(lf, sizeof(LOGFONT));
#ifndef UNICODE
	DebugBreak();
#endif

	::wcsncpy(lf->lfFaceName, familyName, LF_FACESIZE - 1);
...
SkTypeface* SkFontHost::CreateTypefaceA(const SkTypeface* familyFace,
