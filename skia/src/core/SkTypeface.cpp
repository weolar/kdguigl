...
SkTypeface* SkTypeface::CreateFromNameA(const char name[], Style style) {
    return SkFontHost::CreateTypefaceA(NULL, name, style);
}

SkTypeface* SkTypeface::CreateFromName(const wchar_t name[], Style style) {
...
SkTypeface* SkTypeface::Deserialize(SkStream* stream) {
    ...
    return SkTypeface::CreateFromNameA(desc.getFamilyName(), desc.getStyle());
}
