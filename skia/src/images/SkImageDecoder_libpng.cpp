...
static void __cdecl sk_read_fn(png_structp png_ptr, png_bytep data, png_size_t length) {
...
static int __cdecl sk_read_user_chunk(png_structp png_ptr, png_unknown_chunkp chunk) {
...
static void __cdecl sk_error_fn(png_structp png_ptr, png_const_charp msg) {
...
static void __cdecl sk_write_fn(png_structp png_ptr, png_bytep data, png_size_t len) {
