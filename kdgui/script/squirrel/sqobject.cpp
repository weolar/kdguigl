...
bool SQGenerator::SqYield(SQVM *v,SQInteger target)
{
...
SQObjectPtr::SQObjectPtr(const SQObjectPtr &o)
{
	//SQ_OBJECT_RAWINIT()
	_type=o._type;
	_unVal=o._unVal;
...
SQObjectPtr::SQObjectPtr(const SQObject &o)
{
	//SQ_OBJECT_RAWINIT()
	_type=o._type;
	_unVal=o._unVal;
...
SQObjectPtr::SQObjectPtr(bool bBool)
{
	SQ_OBJECT_RAWINIT()
		_type = OT_BOOL;
...
SQObjectPtr& SQObjectPtr::operator=(bool b)
{ 
	__Release(_type,_unVal);
	SQ_OBJECT_RAWINIT()
		_type = OT_BOOL;
...
SQObjectPtr& SQObjectPtr::operator=(const SQObjectPtr& obj)
{ 
...
SQObjectPtr& SQObjectPtr::operator=(const SQObject& obj)
{ 
	SQObjectType tOldType;
	SQObjectValue unOldVal;
	tOldType=_type;
...
void SQObjectPtr::__AddRef(SQObjectType type, SQObjectValue unval)
{
...
void SQObjectPtr::__Release(SQObjectType type, SQObjectValue& unval) 
{
